...
class TestDownloadFlow:
    def test_chrome_download_success(self, mocker, tmp_path):
        # Mock requests.get
    ...
    def test_chrome_download_404(self, mocker, tmp_path):
    ...
    def test_chrome_download_empty_file_cleanup(self, mocker, tmp_path):
