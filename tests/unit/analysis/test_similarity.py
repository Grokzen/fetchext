...
def test_find_similar(engine, tmp_path):
    ...
    with patch.object(engine, "compute_hash") as mock_hash:
        ...
        content2 = (code_base * 5 + "\n# Added a comment here to change it slightly").encode('utf-8')
        content3 = b"some completely different content that has nothing to do with the above" * 50
