...
def test_scan_licenses_zip(fs):
    ...
    with zipfile.ZipFile(zip_path, "w") as zf:
        zf.writestr("LICENSE", "Permission is hereby granted, free of charge, to any person obtaining a copy")
        zf.writestr("script.js", "/* Licensed under the Apache License, Version 2.0 */\nconsole.log('hi');")
