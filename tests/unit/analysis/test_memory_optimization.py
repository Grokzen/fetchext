...
class TestMemoryOptimization:
    ...
    def test_yara_large_file_handling(
        self, mock_unlink, mock_temp, mock_zip, mock_crx, fs
    ):
        ...
        # Ensure the temp file "exists" for os.path.exists check
        fs.create_file("/tmp/tempfile")
