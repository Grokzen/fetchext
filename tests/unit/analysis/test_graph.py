...
def test_build_dependency_graph(tmp_path):
    ...
    with patch("fetchext.analysis.graph.open_extension_archive") as mock_open:
        ...
        assert (
            "lib/helper.js" in graph["main.js"]
        )  # Note: require("./lib/helper") resolves to lib/helper.js (with .js added by logic)
...
def test_generate_dot():
    graph = {"main.js": {"utils.js", "lib/helper.js"}, "utils.js": set()}
...
def test_generate_html():
    ...
    graph = {"main.js": {"utils.js"}, "utils.js": set()}
