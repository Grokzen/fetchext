...
def register(subparsers):
    parser = subparsers.add_parser("share", help="Share a report via Gist or other providers.")
    parser.add_argument("file", help="Path to the report file to share.")
    parser.add_argument("--provider", choices=["gist"], default=None, help="Sharing provider (default: gist).")
