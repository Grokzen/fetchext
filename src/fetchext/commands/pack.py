...
def register(subparsers):
    parser = subparsers.add_parser("pack", help="Pack a directory into a signed CRX3 file")
...
def add_arguments(parser):
    ...
    parser.add_argument("-k", "--key", help="Private key file (PEM). If not provided, one will be generated.")
...
def handle_pack(args):
    ...
    try:
        ...
        console.print(f"[bold green]Success![/bold green] Packed extension to {output_path}")
