...
class CodeBeautifier:
    ...
    def beautify_file(self, file_path: Union[str, Path], in_place: bool = False, output_path: Optional[Path] = None) -> Optional[str]:
        """
    ...
    def beautify_directory(self, dir_path: Union[str, Path], in_place: bool = True) -> None:
        """
