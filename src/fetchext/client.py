...
class NetworkClient:
    ...
    def download_file(self, url: str, output_path: Path, show_progress: bool = True, params: dict = None) -> Path:
        """
        ...
        try:
            ...
            response = self.session.get(url, stream=True, headers=headers, params=params)
            ...
            if response.status_code == 416:
                ...
                response = self.session.get(url, stream=True, headers=retry_headers, params=params)
